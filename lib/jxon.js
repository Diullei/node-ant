...
function toXML(obj, nodeName){
	_common.assert(obj != null, "missing arg: 'obj'")

	if(nodeName) 
		_common.assert(typeof nodeName == 'String', "arg 'nodeName' must be a string")
	...
	_common.assert(hasProperties, "argument 'obj' must have properties")
